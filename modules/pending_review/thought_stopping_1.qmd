...
To sustain recovery, it is necessary to interrupt the [trigger → thought → craving → use](trigger_thought_craving_reading.html) sequence. **Thought stopping** provides a tool for disrupting the process.
